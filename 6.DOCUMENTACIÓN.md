...
### 2.9 - Combinación con código HTML
...
*Se recomienda crear un archivo `.gitignore` con listado de carpetas y archivos a los que no se realizará seguimiento.*
